# Задача
Кнопка выгрузки рабочего пространства при нажатии должны давать 2 пункта выбора:
   - выгрузить в качестве zip архива
   - выгрузить в существующую папку с заменой содержимого

Описание визуального эффекта, который должен происходить при нажатии на кнопку:
- дополнительные пункты меню, должны появляться после нажатия на кнопку
- оба пункта должны быть сгруппированы в линию внутри виджета
- данный виджет, содержащий доп-кнопки, должен появляться путём выдвижения из основной кнопки слева на право
