# Задача: «close all open tabs»

Необходимо добавить возможность закрыть все открытые вкладки.

Данное действие должно быть доступно из ПКМ-меню любой открытой вкладки.
