...
Необходимо предоставить пользователю менять ширину виджета ответственного за отображение дерева локальной файловой системы.
Максимальная ширина = половина рабочей области экрана (вкладки).
